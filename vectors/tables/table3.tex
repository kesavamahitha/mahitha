...
\hhline{|---|}
	...
	&\multicolumn{1}{p{\gnumericColC}|}%
	{\gnumericPB{\raggedright}\gnumbox[l]{Equation of altitude AP}}
\\
\hhline{|--|~}
	 \multicolumn{1}{|p{\gnumericColA}|}%
...
\hhline{|---|}
	...
	&\multicolumn{1}{p{\gnumericColC}|}%
	{\gnumericPB{\raggedright}\gnumbox[l]{Equation of altitude BQ}}
\\
\hhline{|--|~}
	 \multicolumn{1}{|p{\gnumericColA}|}%
...
\hhline{|---|}
	...
	&\multicolumn{1}{p{\gnumericColC}|}%
	{\gnumericPB{\raggedright}\gnumbox[l]{Equation of altitude CR}}
\\
\hhline{|--|~}
	 \multicolumn{1}{|p{\gnumericColA}|}%
...
\hhline{|---|}
	...
	&\multicolumn{1}{p{\gnumericColB}|}%
	{\gnumericPB{\raggedright}\gnumbox[l]{\myvec{\frac{-3}{2}\\\frac{17}{2}\\}}}
	&\multicolumn{1}{p{\gnumericColC}|}%
...
\hhline{|---|}
	...
	{}
	&\multicolumn{1}{p{\gnumericColB}|}%
	{\gnumericPB{\raggedright}\gnumbox[l]{$(A-H)^T.(B-C)=0$}}
	&\multicolumn{1}{p{\gnumericColC}|}%
